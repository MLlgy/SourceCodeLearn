...
import com.example.mkio.importsource.xutils3sample.download.DownloadManager;
...
public class HttpFragment extends BaseFragment {
     ...
     * 4. 其它参数说明见{@link xutils3.view.annotation.Event}类的说明.
     **/
    ...
    private void onTest1Click(View view) {
        /**
         * 自定义实体参数类请参考:
         * 请求注解 {@link xutils3.http.annotation.HttpRequest}
         * 请求注解处理模板接口 {@link xutils3.http.app.ParamsBuilder}
         *
         * 需要自定义类型作为callback的泛型时, 参考:
         * 响应注解 {@link xutils3.http.annotation.HttpResponse}
         * 响应注解处理模板接口 {@link xutils3.http.app.ResponseParser}
         *
         * 示例: 查看 xutils3.sample.http 包里的代码
         */
        ...
        Callback.Cancelable cancelable
                 ...
                 * ...(可参考{@link xutils3.image.ImageLoader}
                 * 或 示例代码中的 {@link xutils3.sample.download.DownloadCallback})
                 *
                 * 3. 请求过程拦截或记录日志: 参考 {@link xutils3.http.app.RequestTracker}
                 *
                 * 4. 请求Header获取: 参考 {@link xutils3.http.app.RequestInterceptListener}
                 *
                 * 5. 其他(线程池, 超时, 重定向, 重试, 代理等): 参考 {@link xutils3.http.RequestParams}
                 *
                 **/
...
//        });
    ...
    /**
     * 缓存示例, 更复杂的例子参考 {@link xutils3.image.ImageLoader}
     */
