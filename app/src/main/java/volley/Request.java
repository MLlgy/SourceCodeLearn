...
import volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     */
    private static final String DEFAULT_PARAMS_ENCODING = "UTF-8";//默认的参数编码格式
     ...
     *
     * @deprecated Use {@link #Request(int, String, volley.Response.ErrorListener)}.
     */
    @Deprecated
    ...
    /**
     * @return this request's {@link volley.Response.ErrorListener}.
     */
