...
import xutils.bitmap.BitmapCacheListener;
import xutils.bitmap.BitmapCommonUtils;
import xutils.bitmap.BitmapDisplayConfig;
import xutils.bitmap.BitmapGlobalConfig;
import xutils.bitmap.callback.BitmapLoadCallBack;
import xutils.bitmap.callback.BitmapLoadFrom;
import xutils.bitmap.callback.DefaultBitmapLoadCallBack;
import xutils.bitmap.core.AsyncDrawable;
import xutils.bitmap.core.BitmapSize;
import xutils.bitmap.download.Downloader;
import xutils.cache.FileNameGenerator;
import xutils.task.PriorityAsyncTask;
import xutils.task.PriorityExecutor;
import xutils.task.TaskHandler;
