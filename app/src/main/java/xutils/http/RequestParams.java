...
import xutils.http.client.entity.BodyParamsEntity;
...
import xutils.http.client.multipart.content.FileBody;
import xutils.http.client.multipart.content.InputStreamBody;
import xutils.http.client.multipart.content.StringBody;
